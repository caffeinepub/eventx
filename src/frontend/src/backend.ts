...
export class Backend implements backendInterface {
    ...
    async createAnnouncement(arg0: string, arg1: string, arg2: AnnouncementPriority): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createAnnouncement(arg0, arg1, to_candid_AnnouncementPriority_n10(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createContestEntry(arg0: ContestEntry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createContestEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createTicket(arg0: Ticket): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createTicket(to_candid_Ticket_n12(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContestEntries(): Promise<Array<ContestEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getContestEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPhotoPosts(): Promise<Array<PhotoPost>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotoPosts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getQuoteRequestsForUser(): Promise<Array<QuoteRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getQuoteRequestsForUser();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTransactions(arg0: Principal): Promise<Array<WalletTransaction>> {
        if (this.processError) {
            try {
    ...
    async recordTransaction(arg0: Principal, arg1: bigint, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async refundTicket(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.refundTicket(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendQuoteRequest(arg0: Principal, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.sendQuoteRequest(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadPhoto(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPhoto(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async validateTicket(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async voteContestEntry(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.voteContestEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AnnouncementPriority_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AnnouncementPriority): AnnouncementPriority {
    return from_candid_variant_n20(_uploadFile, _downloadFile, value);
}
function from_candid_Announcement_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Announcement): Announcement {
    return from_candid_record_n18(_uploadFile, _downloadFile, value);
}
function from_candid_TicketStatus_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TicketStatus): TicketStatus {
    return from_candid_variant_n31(_uploadFile, _downloadFile, value);
}
function from_candid_Ticket_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Ticket): Ticket {
...
function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Ticket]): Ticket | null {
    return value.length === 0 ? null : from_candid_Ticket_n28(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        priority: from_candid_AnnouncementPriority_n19(_uploadFile, _downloadFile, value.priority)
    };
}
function from_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        portfolioUrl: record_opt_to_undefined(from_candid_opt_n26(_uploadFile, _downloadFile, value.portfolioUrl)),
        empresa: record_opt_to_undefined(from_candid_opt_n26(_uploadFile, _downloadFile, value.empresa)),
        cnpjCpf: record_opt_to_undefined(from_candid_opt_n26(_uploadFile, _downloadFile, value.cnpjCpf))
    };
}
function from_candid_record_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_TicketStatus_n30(_uploadFile, _downloadFile, value.status),
        owner: value.owner,
        event: value.event
    };
}
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "emergency" in value ? AnnouncementPriority.emergency : "normal" in value ? AnnouncementPriority.normal : "important" in value ? AnnouncementPriority.important : value;
}
...
function from_candid_variant_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "active" in value ? TicketStatus.active : "invalid" in value ? TicketStatus.invalid : "used" in value ? TicketStatus.used : "refunded" in value ? TicketStatus.refunded : "validating" in value ? TicketStatus.validating : value;
}
function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Announcement>): Array<Announcement> {
    return value.map((x)=>from_candid_Announcement_n17(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Ticket>): Array<Ticket> {
    return value.map((x)=>from_candid_Ticket_n28(_uploadFile, _downloadFile, x));
}
...
function to_candid_TicketStatus_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TicketStatus): _TicketStatus {
    return to_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function to_candid_Ticket_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Ticket): _Ticket {
...
function to_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: to_candid_TicketStatus_n14(_uploadFile, _downloadFile, value.status),
        owner: value.owner,
        event: value.event
    };
}
...
function to_candid_record_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        cnpjCpf: value.cnpjCpf ? candid_some(value.cnpjCpf) : candid_none()
    };
}
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AnnouncementPriority): {
    ...
    return value == AnnouncementPriority.emergency ? {
        emergency: null
...
function to_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TicketStatus): {
    active: null;
} | {
    invalid: null;
} | {
    ...
    return value == TicketStatus.active ? {
        active: null
